        ...
        <View className='flex flex-col w-full h-1/2 items-center justify-end space-y-3 '>
            ...
            <View className='w-5/6 space-y-1'>
                ...
                <TextInput
                    ...
                    className={` px-5 flex items-center rounded-full border bg-gray-200 ${Platform.OS === 'ios'? 'p-4' : 'p-2'}`}
                    value={name}
                    maxLength={15}
            ...
            <View className='w-5/6 space-y-1'>
                ...
                <TextInput
                    ...
                    value={age}
                    maxLength={2}
                    className={`px-5 flex items-center border w-1/3 rounded-full bg-gray-200 ${Platform.OS === 'ios' ? 'p-4' : 'p-2'}`}
